select autnot.idusuario, nombre, apellido, titulo, autnot.Fecha, count(*) as 'Leidas', sum(if(megusta=1,1,0))as 'Me gusta' from reg_navegacion join
(select nombre, apellido, titulo, usuario_mod.idusuario as idusuario, noticia_mod.fecha as Fecha, noticia_mod.idnoticia
...
group by usuario_actual.id_usuario
) autnot 
